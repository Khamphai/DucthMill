...
<div class="container">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM invoice i INNER JOIN customer c ON(i.cus_id=c.cus_id) WHERE status='Receive' ORDER BY i.id_invoice DESC";
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <a href="print_receive.php?order_id=<?= $id_invoice ?>" class="btn btn-warning" target="_blank">Print</a>
                        </div>
                    </div>
