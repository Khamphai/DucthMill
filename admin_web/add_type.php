...
<div class="container">
    <div class="row">
        ...
        <form action="process_type.php?type=add" method="POST" enctype="multipart/form-data" class="form-group row col-lg-6 form1" style="text-alight:left"
              id="log">
            <legend style="font-family:Phetsarath OT; color:blue; font-size:40px ; text-align:center;"></legend>

            <div class="form-group">
                <label>Name Type</label>
                <input class="form-control" type="text" placeholder="" name="name_type">
            </div>
            <div class="form-group">
