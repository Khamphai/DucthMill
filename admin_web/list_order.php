...
<div class="container">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM invoice i INNER JOIN customer c ON(i.cus_id=c.cus_id) WHERE status IN('Pending', 'Paid') ORDER BY i.id_invoice DESC";
                    ...
                    <div class="panel-body">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="process_cus.php?type=update&status=Paid&id=<?= $id_invoice ?>">Paid</a></li>
                                <li><a href="process_cus.php?type=update&status=Receive&id=<?= $id_invoice ?>">Receive</a></li>
                            </ul>
                        </div>
                    </div>
