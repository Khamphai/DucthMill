...
<!--<div class="page-header" style="background-color:#AFEEEE;margin-top:-20px;height:130px;font-family:Phenomena;font-weight:bold; font-size:70px;text-align:center; ">
 ...
 <a class="navbar-brand" href="#" ><img src="logo/logoducth.png" width="90" height="90" margin-top="-2px" /></a>
    ...
    <ul class="nav navbar-nav" style=" font-size:20px; ">
		<li><a href="check_staff.php" style="font-family:Phetsarath OT; color:#5f0f28">ລາຍການກວດສອບສິນຄ້າທີ່ໄດ້ສົ່ງ</a></li>
		
		<li class="dropdown" ><a class="dropdown-toggle" data-toggle="dropdown" style="font-family:Phetsarath OT; color:#5f0f28">
		ການຈັດການ<span class="caret"></span></a>
			<ul class="dropdown-menu" style="font-size:20px" >
			  <li><a href="sending.php">ການສົ່ງສິນຄ້າ </a></li>
			  <li><a href="lading.php">ການເບີກສິນຄ້າຈາກຝ່າຍຂາຍ</a></li>
